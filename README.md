...
└── README.md
 ...
 Data Sources:
SourceDescriptionLinkUN ComtradeGlobal trade database (exports/imports by product & country)comtrade.un.orgWTO StatisticsWorld trade organization datadata.wto.orgITC Trade MapAggregated trade flowstrademap.orgWorld BankGDP, economic indicators, WITSdata.worldbank.org
...
Step 4 : Evaluation
TaskMetricsForecastingMAE, RMSE, MAPEClassificationAccuracy, Precision, Recall, F1-scoreClusteringSilhouette Score, Davies-Bouldin Index
